...
if sandi == 'Farel' and user == 'Zeus':
    print 'Loe Telah Login'
    sys.exit
else:
    print 'Login Loe GAGAL, Silahkan hubungi ADMIN'
    wa()
    restart()
...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN FACEBOOK Loe \x1b[1;91m[\xe2\x98\x86]'
